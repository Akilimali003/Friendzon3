...
import vijey.gamedesigner.cd.friendzone.models.ChatMessage
import vijey.gamedesigner.cd.friendzone.models.User
import vijey.gamedesigner.cd.friendzone.registration.LoginActivity
import vijey.gamedesigner.cd.friendzone.views.LatestMessageRow
...
class LatestMessagesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /** Trying to adapt a recycle view for the latest user's message at the top
         * of the screen,, this is a whiling code for a test ***/
        recycleview_latest_messages.scrollToPosition(adapter.itemCount +1)
